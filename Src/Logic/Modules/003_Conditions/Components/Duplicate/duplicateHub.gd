...
extends Component
class_name Comp_Cond_Duplicate
...
# --- File ----------- #
########################
var foo = load("res://Src/Logic/Modules/003_Conditions/Components/Duplicate/Strategies/bar.gd")
var bar = load("res://Src/Logic/Modules/003_Conditions/Components/Duplicate/Strategies/foo.gd")

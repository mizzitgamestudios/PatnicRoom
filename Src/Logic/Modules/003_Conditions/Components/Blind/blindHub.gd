...
var noStimulation = preload("res://Src/Logic/Modules/003_Conditions/Components/Blind/Strategies/noStimulation.gd")
var overStimulation = preload("res://Src/Logic/Modules/003_Conditions/Components/Blind/Strategies/overStimulation.gd")

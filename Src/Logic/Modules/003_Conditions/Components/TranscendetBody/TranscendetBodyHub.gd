...
var foo = load("res://Src/Logic/Modules/003_Conditions/Components/TranscendetBody/Strategies/bar.gd")
var bar = load("res://Src/Logic/Modules/003_Conditions/Components/TranscendetBody/Strategies/foo.gd")

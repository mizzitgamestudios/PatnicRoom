...
# --- File ----------- #
########################
var foo = load("res://Src/Logic/Modules/003_Conditions/Components/Solidify/Strategies/bar.gd")
var bar = load("res://Src/Logic/Modules/003_Conditions/Components/Solidify/Strategies/foo.gd")

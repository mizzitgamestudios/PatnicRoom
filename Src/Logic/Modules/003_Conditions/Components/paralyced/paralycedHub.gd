...
# --- File ----------- #
########################
var foo = load("res://Src/Logic/Modules/003_Conditions/Components/paralyced/Strategies/bar.gd")
var bar = load("res://Src/Logic/Modules/003_Conditions/Components/paralyced/Strategies/foo.gd")

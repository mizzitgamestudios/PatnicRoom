...
# --- File ----------- #
########################
var foo = load("res://Src/Logic/Modules/01_01 Conditions/Components/Burning/Strategies/foo.gd")
var bar = load("res://Src/Logic/Modules/01_01 Conditions/Components/Burning/Strategies/bar.gd")

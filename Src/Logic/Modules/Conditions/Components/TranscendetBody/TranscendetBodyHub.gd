...
var foo = preload("res://Src/Logic/Modules/Conditions/Components/TranscendetBody/Strategies/bar.gd")
var bar = preload("res://Src/Logic/Modules/Conditions/Components/TranscendetBody/Strategies/foo.gd")

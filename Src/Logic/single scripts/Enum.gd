...
enum TYPES_ON_MAP{TILE,ACTOR,INTERACT,MARKER,PLAYER}
...
const MINIMAL_COMP_KITPART_ENT  = [C_37_ANY_M_TYPE,C_31_KIT_CAT_TYPE,C_40_ANY_TO_STRING,C_35_KIT_MECHANICAL_SUMMARY,C_37_ANY_M_TYPE,C_31_KIT_CAT_TYPE,C_38_KIT_PART_TYPE,C_36_KIT_MOD_TIME,C_33_KIT_COOLDOWN_TIMER,C_48_ANY_RARITY,C_49_EFFECT_REFERENCE]

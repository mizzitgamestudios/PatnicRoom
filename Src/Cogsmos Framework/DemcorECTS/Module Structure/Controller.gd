...
func getEntity(entity_instance_ID:int):     return self._try_get_entry_of_array(_arra_entity,entity_instance_ID)
func getTemplate(template_instance_ID:int): return self._try_get_entry_of_array(_arra_template,template_instance_ID)
...
func hasEntity(entity_instance_ID:int):     return self._try_has_array_searched_entry(_arra_entity,entity_instance_ID)
func hasTemplate(template_instance_ID:int): return self._try_has_array_searched_entry(_arra_template,template_instance_ID)
...
func connectEntityToController(ent:Entity):
	var entInstID = ent.get_instance_id()
...
func dicconnectEntityToController(entity:Entity):
	var entity_instance_id = entity.get_instance_id()
...
func _try_has_array_searched_entry(array:Array,entry:int):  return array.has(entry)
func _try_can_entry_get_removed(array:Array,entry:int):     return !_try_has_array_searched_entry(array,entry)


func _try_get_entry_of_array(array:Array,entry:int):
	if _try_has_array_searched_entry(array,entry): return instance_from_id(entry)
	else:

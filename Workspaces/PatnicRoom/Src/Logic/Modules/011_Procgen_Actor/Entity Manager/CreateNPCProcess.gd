...
func getMainTemplates(dictionary:Dictionary):
	pass
	raceTemplate = API_001_Atlas.RaceAtlas()[dictionary["C_11_ACTOR_RACE_NAME"]]
	roleTemplate = API_001_Atlas.RoleAtlas()[dictionary["C_13_ACTOR_ROLE_NAME"]]
	specialtyTemplate = API_001_Atlas.SpecialtyAtlas()[dictionary["C_14_ACTOR_SPECIALTY_NAME"]]

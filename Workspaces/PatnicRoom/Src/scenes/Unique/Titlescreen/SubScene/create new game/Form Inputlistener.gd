...
func manageCheckboxes(checkbox):
	match checkbox.grouping:
		"perk":
			API_006_Player.chargenSelecttion["perks"] = checkbox.toString
			clearBoxfield(allPerkCheckboxes)

		"kit":
			API_006_Player.chargenSelecttion["Kits"] = checkbox.toString
			clearBoxfield(allKitCheckboxes)
		"race":
			API_006_Player.chargenSelecttion["race"] = checkbox.toString

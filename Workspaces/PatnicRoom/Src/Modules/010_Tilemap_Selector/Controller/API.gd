...
func drawCrosshairOnPos(reach:int,pos:Vector2,texture):
	...
	selectManager.manageSelectByKeyword("LINEA",subFuncPara)


# ---- Area ---- #
func drawAreaOnPos(reach:int,pos:Vector2,texture):
	var subFuncPara = { "reach":reach, "pos":pos, "texture":texture }
	selectManager.manageSelectByKeyword("AREA",subFuncPara)
...
func drawQuadOnPos(reach:int,pos:Vector2,texture):
	var subFuncPara = { "reach":reach, "pos":pos, "texture":texture }
	selectManager.manageSelectByKeyword("SELECT",subFuncPara)
...
func collectSelectedTiles(kitSet:KitSetEntity):
